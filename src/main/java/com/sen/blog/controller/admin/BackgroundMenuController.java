...
public class BackgroundMenuController extends CommonValidatorMethod<Menu> {
    ...
    public String editSubmit(Menu menu, Model model, HttpServletResponse response) {
        if (!validate(model, menu, "/admin/menu", response)) {
            return null;
        }
    ...
    public String insertSubmit(Menu menu, Model model, HttpServletResponse response) {
        if (!validate(model, menu, "/admin/menu", response)) {
            return null;
        }
