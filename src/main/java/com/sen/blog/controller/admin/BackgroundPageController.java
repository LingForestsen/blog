...
public class BackgroundPageController extends CommonValidatorMethod<Page> {
    ...
    public String pageEditSubmit(Page page, RedirectAttributes redirectAttributes, HttpServletResponse response) {
        if (!validate(redirectAttributes, page, "/admin/page", response)) {
            return null;
        }
    ...
    public String insertPageSubmit(Page page, HttpServletResponse response, RedirectAttributes redirectAttributes) {
        if (!validate(redirectAttributes, page, "/admin/page/insert", response)) {
            return null;
        }
